...
def generate_summary(text_list):
    ...
    prompt = (f"I have text containing negative restaurant reviews. Summarize the reviews into pointers.{text_list}")
    
    # Use OpenAI's GPT-3 to generate solutions based on input text
    response = openai.Completion.create( model="gpt-3.5-turbo", prompt=prompt, max_tokens=500,temperature=0)
