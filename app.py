...
def generate_summary(text_list):
    ...
    # Use OpenAI's language models to generate solutions based on input text
...
def generate_solution( text_list):
    ...
    # Define prompt for GPT-3
    prompt = (f"I have a variable containing negative reviews: {text_list}. Summarize solutions that you can recommend in pointers")
